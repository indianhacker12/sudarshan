#!/usr/bin/env python3
"""
Sudarshan AI Security Scanner - Main Entry Point
...
async def main():
    """Main entry point for Sudarshan AI Security Scanner"""
...
Use sudarshan.py for simplified mode selection:
  python sudarshan.py -u <URL> --basic       # Fast scan (Fast)
  python sudarshan.py -u <URL>               # Medium scan (Standard)
