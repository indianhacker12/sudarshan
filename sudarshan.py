#!/usr/bin/env python3
"""
Sudarshan AI Security Scanner - Main Launcher
Clean, simple launcher for the Sudarshan security scanner
"""
...
========================================================================
     ...
     SUDARSHAN AI SECURITY SCANNER v1.0                                 
...
[BASIC SCAN] (--basic)
   ...
   Command:  python sudarshan.py -u <URL> --basic
...
[MEDIUM SCAN] (default)
   ...
   Command:  python sudarshan.py -u <URL>
...
[AGGRESSIVE SCAN] (--aggressive)
   ...
   Command:  python sudarshan.py -u <URL> --aggressive
...
Aggressive Scan (Thorough):
  python sudarshan.py -u http://testphp.vulnweb.com/ --aggressive

Verbose Output:
  python sudarshan.py -u http://testphp.vulnweb.com/ --verbose

Test Targets (For Practice):
  python sudarshan.py -u http://testphp.vulnweb.com/      # Vulnerable PHP app
  python sudarshan.py -u http://demo.testfire.net/        # Banking demo
  python sudarshan.py -u https://httpbin.org/             # HTTP testing
