#!/usr/bin/env python3
"""
Quick Test Script for Sudarshan AI Security Scanner
...
async def quick_test():
    ...
    print(" Running Quick Test of Sudarshan AI Security Scanner")
    print("=" * 60)
...
def show_features():
    ...
    print("[SHIELD] Sudarshan AI SECURITY SCANNER - KEY FEATURES")
    print("=" * 60)
    print()
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Sudarshan AI Security Scanner Quick Test")
