...
# Sudarshan AI Security Scanner Installation Script
# Supports Linux and macOS

set -e

echo "🛡️  SUDARSHAN AI SECURITY SCANNER - Installation"
echo "================================================"
...
main() {
    echo
    print_status "Starting Sudarshan AI Security Scanner installation..."
    echo
    ...
    echo
    print_success "🎉 SUDARSHAN Installation Completed Successfully!"
    echo
    ...
    echo
    echo "  CLI Scans:"
    echo "    $PYTHON_CMD sudarshan.py -u https://httpbin.org --basic"
    echo "    $PYTHON_CMD sudarshan.py -u https://httpbin.org"
    echo "    $PYTHON_CMD sudarshan.py -u https://httpbin.org --aggressive"
    echo
    echo "  Verify Installation Anytime:"
    echo "    $PYTHON_CMD verify_installation.py"
    echo
    echo "  Get Help:"
    echo "    $PYTHON_CMD sudarshan.py --help"
