"""
Report Generator for Sudarshan AI Security Scanner
...
<head>
    ...
    <title>Sudarshan AI Security Report - {scan_results['target']}</title>
    ...
    <div class="main-container">
        ...
        <div class="report-header">
            <h1 class="report-title">
                <i class="fas fa-shield-alt"></i> Sudarshan AI Security Report
            </h1>
        ...
        html_content += f"""
        <div class="footer">
            <p><i class="fas fa-robot"></i> Generated by Sudarshan AI Security Scanner</p>
