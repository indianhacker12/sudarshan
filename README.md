...
**SUDARSHAN** (Advanced Security Testing & Risk Assessment with Vulnerability Analysis) is a professional-grade AI-powered web application security scanner designed for:
...
SUDARSHAN combines traditional vulnerability scanning with cutting-edge AI technology to provide:
...
SUDARSHAN has been tested and works perfectly on:
...
python sudarshan.py -u http://testphp.vulnweb.com/

# Banking demo application
python sudarshan.py -u http://demo.testfire.net/

# HTTP testing service
python sudarshan.py -u https://httpbin.org/
```
...
**Command:**
```bash
python sudarshan.py -u <URL> --basic
```
...
**Command:**
```bash
python sudarshan.py -u <URL> --aggressive
```
...
# Or use CLI
python3 sudarshan.py -u http://testphp.vulnweb.com/ --basic
```
...
sudo python3 sudarshan.py -u <URL>
```

**Add to PATH (Optional):**
```bash
# Add alias to .bashrc or .zshrc
echo "alias sudarshan='python3 ~/path/to/sudarshan.py'" >> ~/.bashrc
source ~/.bashrc
...
SUDARSHAN works alongside other Kali tools:

```bash
# Use with nmap results
nmap -sV target.com -oX scan.xml
python3 sudarshan.py -u http://target.com

# Use with nikto
nikto -h target.com
python3 sudarshan.py -u http://target.com --aggressive

# Use with burpsuite
# Export targets from Burp and scan with SUDARSHAN
python3 sudarshan.py -u http://target.com --owasp-all
```
...
python3 sudarshan.py -u <URL> --threads 5

# Increase timeout for slow connections
python3 sudarshan.py -u <URL> --timeout 60
```

**Save Resources:**
```bash
# Use basic scan for quick checks
python3 sudarshan.py -u <URL> --basic
...
**Q: Is SUDARSHAN free to use?**  
A: Yes, SUDARSHAN is open-source and free under MIT License.

**Q: Can I use it for commercial purposes?**  
A: Yes, but only on systems you own or have permission to test.

**Q: Does it work on Windows?**  
A: Yes, SUDARSHAN supports Windows, Linux, and macOS.
...
A: Yes! SUDARSHAN works perfectly on Kali Linux, Parrot OS, and all Debian-based distributions.
...
SUDARSHAN is designed for authorized security testing and educational purposes only.
