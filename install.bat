@echo off
REM Sudarshan AI Security Scanner Installation Script for Windows
...
echo.
echo ================================================================
echo    🛡️  SUDARSHAN AI SECURITY SCANNER - Installation (Windows)
echo ================================================================
echo.
...
echo.
echo ================================================================
echo    🎉 SUDARSHAN Installation Completed Successfully!
echo ================================================================
echo.
...
echo.
echo   CLI Scans:
echo     python sudarshan.py -u https://httpbin.org --basic
echo     python sudarshan.py -u https://httpbin.org
echo     python sudarshan.py -u https://httpbin.org --aggressive
echo.
echo   Verify Installation Anytime:
echo     python verify_installation.py
echo.
echo   Get Help:
echo     python sudarshan.py --help
