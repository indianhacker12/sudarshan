#!/usr/bin/env python3
"""
Sudarshan AI Security Scanner - Usage Examples
...
def print_usage_examples():
    ...
    print("=" * 80)
    print("Sudarshan AI SECURITY SCANNER - COMMAND LINE EXAMPLES")
    print("=" * 80)
    print()
...
async def run_all_examples():
    ...
    print(" Running Sudarshan AI Security Scanner Examples")
...
async def run_comprehensive_examples():
    ...
    print(" Running Comprehensive Sudarshan Examples")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Sudarshan AI Security Scanner Examples")
